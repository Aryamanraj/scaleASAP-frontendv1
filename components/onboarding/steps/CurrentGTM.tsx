        ...
        >
            <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-500">
                ...
                <div className="space-y-4">
                    <h3 className="font-medium text-[#4A4A4A]">Cold Email</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="ce-sent">Sent to (leads)</Label>
                            <Input
                                id="ce-sent"
                                type="number"
                                placeholder="0"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="ce-rate">Reply rate (%)</Label>
                            <Input
                                id="ce-rate"
                                placeholder="%"
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="ce-msg">Best message that worked</Label>
                        <Textarea
                            id="ce-msg"
                ...
                {/* LinkedIn */}
                <div className="space-y-4">
                    <h3 className="font-medium text-[#4A4A4A]">LinkedIn</h3>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="li-sent">Sent to (people)</Label>
                            <Input
                                id="li-sent"
                                type="number"
                                placeholder="0"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="li-rate">Reply rate (%)</Label>
                            <Input
                                id="li-rate"
                                placeholder="%"
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="li-msg">Best message that worked</Label>
                        <Textarea
                            id="li-msg"
                            placeholder="Enter details..."
                            className="min-h-[80px]"
                ...
                {/* Inbound */}
                <div className="space-y-4">
                    <h3 className="font-medium text-[#4A4A4A]">Inbound/Content</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-2">
                            <Label htmlFor="in-traffic">Traffic (visitors/mo)</Label>
                            <Input
                                id="in-traffic"
                                placeholder="0"
                        ...
                        <div className="space-y-2">
                            <Label htmlFor="in-source">What drove quality leads?</Label>
                            <Input
                                id="in-source"
                                placeholder="e.g. SEO"
                ...
                <div className="space-y-2">
                    <Label htmlFor="other-channels">Other (ads, events, referrals)</Label>
                    <Input
                        id="other-channels"
                ...
                <div className="space-y-6">
                    <h3 className="font-medium text-[#4A4A4A]">Your List</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            <Label htmlFor="list-size">I have a list of (contacts)</Label>
                            <Input
                                id="list-size"
                                placeholder="e.g. 500"
                                value={data.listSize}
                                ...
                                {['Scraped', 'Bought', 'Built manually', "Don't have one"].map((src) => (
                                    <div key={src} className="flex items-center space-x-2">
                                        <RadioGroupItem
                                            ...
                                            id={`src-${src}`}
                                        />
                                        <Label htmlFor={`src-${src}`} className="font-normal cursor-pointer">{src}</Label>
                                    </div>
                                ))}
                            </RadioGroup>
                        </div>
                                ...
                                {['<1mo', '1-3mo', '3-6mo', 'Never'].map((t) => (
                                    <div key={t} className="flex items-center space-x-2">
                                        <RadioGroupItem
                                            ...
                                            id={`t-${t}`}
                                        />
                                        <Label htmlFor={`t-${t}`} className="font-normal cursor-pointer">{t}</Label>
                                    </div>
                                ))}
                            </RadioGroup>
                        </div>
